        ...
        <>
            ...
            <div className="mt-20 relative h-[75vh] min-h-[460px] w-full overflow-hidden rounded-b-[36px]">
                ...
                <div className="relative mx-auto flex h-full max-w-6xl flex-col items-center justify-center px-4 text-center text-white">
                    ...
                    <div className="mt-8 w-full max-w-3xl flex items-center justify-around rounded-2xl bg-white/90 p-3 text-left text-[#0b1a3a] shadow-xl">
                        <Link
                            href="/courses"
                            className="cst_btn-primary block text-center text-xl w-full"
                        >
                            Khóa học
                        </Link>
                    </div>
