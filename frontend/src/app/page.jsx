      ...
      <div className="mt-20 relative h-[75vh] min-h-[460px] w-full overflow-hidden rounded-b-[36px]">
        ...
        <div className="relative mx-auto flex h-full max-w-6xl flex-col items-center justify-center px-4 text-center text-white">
          ...
          <p className="mt-3 max-w-2xl text-white/95">
            Khám phá ngôn ngữ, làn điệu và câu chuyện văn hoá địa phương qua bài
            học tương tác và kho tư liệu số hoá.
          </p>

          {/* Segmented Tabs */}
          <div className="mt-10 flex items-center justify-between gap-10 rounded-2xl bg-white/20 p-3 1 ring-white/40 backdrop-blur">
          ...
          <div className="text-sm lg:text-lg mt-10 flex items-center justify-between gap-4 rounded-2xl bg-white/20 p-3 1 ring-white/40 backdrop-blur">
            <Link href="/courses" className="cst_btn-primary">
              Khóa học
            </Link>
            <Link href="/about" className="cst_btn-primary">
              chúng tôi
            </Link>
            <Link href="/translate" className="cst_btn-primary">
              Từ điển
            </Link>
          </div>
        </div>
  ...
  return (
    <div className="group overflow-hidden rounded-2xl ring-1 ring-blue-300/40 shadow-[0_12px_36px_rgba(2,6,23,0.12)]">
      ...
      <div className="bg-white p-4">
        <h4 className="text-[15px] font-bold text-[#0b1a3a]">{title}</h4>
        <p className="mt-1 line-clamp-2 text-sm text-[#0b1a3a]/75">{desc}</p>
    ...
    <section className="max-w-screen-xl mx-auto my-12  px-4">
      <div className="overflow-hidden rounded-3xl bg-[linear-gradient(90deg,#2563eb_0%,#60a5fa_100%)] p-8 text-white ring-1 ring-white/30">
        ...
        <p className="mt-1 text-white/95">
          Học theo chủ đề, nghe phát âm bản ngữ, tích lũy huy hiệu và cùng cộng
          đồng lan toả văn hoá.
        </p>
...
function Input({ label, placeholder }) {
  return (
    <label className="flex w-full flex-col gap-1">
      <span className="text-xs font-semibold text-[#0b1a3a]/70">{label}</span>
      <input
