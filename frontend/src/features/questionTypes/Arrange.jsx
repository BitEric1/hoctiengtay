...
function ArrangeSentence() {
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-blue-50 to-white transition-all duration-500 ease-in-out ${isTransitioning ? "opacity-50 pointer-events-none" : "opacity-100"
        }`}
    >
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className={`flex flex-col items-center gap-6 w-full ${isTransitioning ? "opacity-50 pointer-events-none" : "opacity-100"
            }`}
        >
          <div
            className={`bg-white shadow-lg rounded-2xl p-6 w-[90%] max-w-md flex flex-col items-center gap-6 border transition-all duration-300 ${checked === "wrong"
          ...
          >
            ...
            <div
              className={`min-h-[70px] flex flex-wrap justify-center gap-2 border-2 rounded-2xl p-3 w-full transition-all duration-300 ${checked === "wrong"
